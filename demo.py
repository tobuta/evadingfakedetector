...
if __name__ == "__main__":
    ...
    parser.add_argument('--real_path', default='/houyang/ns235x/demo/real', help='Path to real images')
    parser.add_argument('--real_label', type=int, default=0, help='Label for real images')
    parser.add_argument('--fake_path', default='/houyang/ns235x/demo/real', help='Path to fake images')
    ...
    parser.add_argument('--result_dir', default='/houyang/ns235x/result', help='Directory to save results')
